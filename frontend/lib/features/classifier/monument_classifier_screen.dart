...
class MonumentClassifierScreen extends StatefulWidget {
  const MonumentClassifierScreen({super.key});

  @override
  State<MonumentClassifierScreen> createState() =>
      _MonumentClassifierScreenState();
}

class _MonumentClassifierScreenState extends State<MonumentClassifierScreen> {
<<<<<<< HEAD
  Uint8List? _webImage;
  XFile? _pickedFile;
...
<<<<<<< HEAD
  Future<void> _analyzeMonument() async {
...
=======
      ...
      request.fields['category'] = 'monument';
      ...
      if (response.statusCode == 200) {
        ...
        if (result['status'] == 'success') {
          setState(() {
            ...
            _isFavorite = false; // No ID yet, so not favorite
            _isAnalyzing = false;
          });
        } else {
    ...
    return Container(
      ...
      child: _webImage != null
          ...
          : const Column(
              ...
              children: [
                Icon(Icons.fort_outlined, size: 50, color: Colors.grey),
                SizedBox(height: 10),
                Text("Scan a Moroccan Landmark",
  ...
  Widget _buildAnalyzeButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: _isAnalyzing ? null : _analyzeMonument,
        child: _isAnalyzing
            ? const SizedBox(
                height: 20,
                width: 20,
...
<<<<<<< HEAD
            : Text(
                _useGemini ? "Identify Landmark (Gemini)" : "Identify Landmark (Local)",
          ...
          Row(
            ...
            children: [
              const Text(
                ...
                style:
                    TextStyle(color: Color(0xFF006233), fontWeight: FontWeight.bold),
              ),
              if (source != null)
                Container(
...
>>>>>>> a3ee2d642313047e3104f22ed8ad1d795e967dcc
          ...
          Text(
            "Monument: ${_analysisResult?['name'] ?? 'Unknown'}",
          ...
          Text(
            "Location: ${_analysisResult?['city'] ?? 'Morocco'}",
            style: const TextStyle(
